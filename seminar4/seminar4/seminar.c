...
//void * e um pointer generic, aceita retornar qualquer pointer de qualquer tipo, podemos trocar para Nod* ja que retornamos Nod* 
...
int main() {
	Nod* masini = citireListaMasiniDinFisier("masina.txt");
	afisareListaMasini(masini);
	printf("--------PRET MEDIU-------------\n");
	float pretmediu = calculeazaPretMediu(masini);
	printf(".2%f\n", pretmediu);
	printf("-------------- SUMA MASINI SOFER-------------\n");
	printf("Suma masinilor lui Ionescu: %.2f\n", calculeazaPretulMasinilorUnuiSofer(masini, "Ionescu"));
